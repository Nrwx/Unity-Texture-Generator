from model.cursor_model import CursorModel
...
class CursorController:
    ...
    METHOD_MAP = {
        "create": {
            "keys": {"id", "size", "rotation", "opacity"},
            "function": CursorModel.generate_cursor_file
        }
    }

    @classmethod
    def handle(cls, form):
        params = parse_parameters(PARAMETERS['cursor'], form)
