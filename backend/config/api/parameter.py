...
PARAMETERS = {
    ...
    "mesh": {
        "method": {"type": str, "required": True},
        "id": {"type": str, "default": ""},
        "name": {"type": str, "default": "Mesh Layer"},
        "width": {"type": int, "default": 1024},
        "height": {"type": int, "default": 1024},
        "hidden": {"type": int, "default": 0},
        "opacity": {"type": float, "default": 1},
        "order": {"type": int, "default": 0},
        "matrix": {"type": dict, "default": {}},
        "keyframes": {"type": list, "default": []},
        "geometry": {"type": dict, "default": {}},
        "mesh": {"type": dict, "default": {}},
        "geometry_manifest": {"type": dict, "default": {}},
        "mesh_manifest": {"type": dict, "default": {}},
        "geometry_payload": {"type": dict, "default": {}},
        "settings": {"type": dict, "default": {}},
        "preview": {"type": dict, "default": {}},
        "viewport_camera": {"type": dict, "default": {}},
        "material": {"type": dict, "default": {}},
        "shader": {"type": dict, "default": {}},
    ...
    "export": {
        ...
        "videoDurationSeconds": {"type": float, "default": 0},
        "frameCount": {"type": int, "default": 0},
        "durationSeconds": {"type": float, "default": 0},
        "encodedDurationSeconds": {"type": float, "default": 0},
        "timelineUnitsPerSecond": {"type": float, "default": 60},
        "frameIndex": {"type": int, "default": 0},
        "frameTime": {"type": float, "default": 0},
        "mediaTimeSeconds": {"type": float, "default": 0},
        "sessionId": {"type": str, "default": ""},
        "videoResolution": {"type": int, "default": 1024},
        "videoProfile": {"type": str, "default": "main"},
        "videoPreset": {"type": str, "default": "normal"},
        "videoEncoding": {"type": str, "default": "crf"},
        "videoBitrate": {"type": int, "default": 8000},
        "videoCrf": {"type": int, "default": 16},
        "useFileSystem": {"type": bool, "default": True},
    },
    "render": {
        "method": {"type": str, "required": True},
        "id": {"type": str, "default": ""},
        ...
        "geometry": {"type": dict, "default": {}},
        "mesh": {"type": dict, "default": {}},
        "light": {"type": dict, "default": {}},
        "physics": {"type": dict, "default": {}},
        ...
        "render_backend": {"type": str, "default": "WEBGL2"},
        "alpha_clip": {"type": float, "default": 0.5},
        "shadow_method": {"type": str, "default": "HASHED"},
        "backface_culling": {"type": bool, "default": False},
        "show_backface": {"type": bool, "default": True},
        "screen_space_refraction": {"type": bool, "default": False},
        "refraction_depth": {"type": float, "default": 0.0},
        "subsurface_translucency": {"type": bool, "default": False},
