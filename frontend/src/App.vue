<template>
  <v-app :id="tempData.appId.value">
    ...
    <template v-if="!windowStates.boot.value && !windowStates.viewport.value">
      ...
      <v-main>
        <!-- Grid -->
        <Grid v-model:animator-state="windowStates.animator.value" v-model:export-state="windowStates.export.value" v-model:edit-text="windowStates.textEdit.value" v-model:edit-text-layer="tempData.editTextLayer.value" v-model:status="statusBarItems" v-model:cursor-vector="localData.cursorVector.value" v-model:select-box="localData.selectItemsBox.value" v-model:eraser="windowStates.eraser.value"  v-model:layer-states="layerStates" v-model:brush-canvas-id="tempData.brushCanvasId.value" v-model:canvas-id="tempData.canvasId.value" v-model:rule="ruleStates.form.value" v-model:timeline="windowStates.timeline.value" v-model:mini-timeline="windowStates.miniTimeline.value" v-model:timeline-play="timelineStates.play.value" v-model:time="timelineData.time" v-model:timeline-record="timelineStates.record.value" v-model:path-drag="windowStates.pathDrag.value" v-model:selected-path="localData.selectedPath.value" v-model:container-states="containerStates" v-model:backup="backupStates.action.value" v-model:form-rule="ruleStates.form.value" @component-event="componentEvent" v-model:path-import="windowStates.pathImport.value" v-model:bezier="localData.bezier.value" v-model:layers="localData.layers.value" v-model:selected-layer="localData.selectedLayer.value" v-model:text-layer="textLayer" v-model:brush-cursor="localData.cursor.value" v-model:color="localData.color.value" v-model:settings="localData.viewport.value" v-model:guides="localData.guides.value" v-model:fill-state="modifierStates.fill.value" v-model:select="windowStates.select.value" v-model:select-mode="localData.selectedShape.value" v-model:text="windowStates.text.value" v-model:brushes="localData.brush.value" v-model:brush-settings="brushSettings" v-model:brush="windowStates.brush.value" v-model:drawing="windowStates.drawing.value" v-model:pen="windowStates.pen.value" v-model:path-layer="pathLayer" :viewport="{width: localData.viewport.value.width, height: localData.viewport.value.height}" :theme="appData.theme.value" :loading="localData.loading.value" :pen-path-state="windowStates.path.value" style="position: relative;">
          <!-- Mittige Taskbar -->
