...
export function exportModel(props, emit) {
    ...
    const config = reactive({
        ...
        videoDurationSeconds: exportData.value.videoDurationSeconds,
        videoResolution: exportData.value.videoResolution,
        videoProfile: exportData.value.videoProfile,
        videoPreset: exportData.value.videoPreset,
        videoEncoding: exportData.value.videoEncoding,
        videoBitrate: exportData.value.videoBitrate,
        videoCrf: exportData.value.videoCrf,
        useFileSystem: exportData.value.useFileSystem,
    });
    ...
    const operation = computed(() =>({
        43: {
            ...
            videoDurationSeconds: {
                ...
                max: 28800,
                step: 0.1,
                event: 'export:video-duration',
                active: exportData.value.type === 'MP4',
                title: 'Video-Dauer',
                subtitle: 'Reale MP4-Laenge in Sekunden. 0 nutzt die Timeline-Laenge als Fallback.',
            ...
            videoResolution: {
                ...
                max: 4096,
                step: 16,
                event: 'export:video-resolution',
                active: exportData.value.type === 'MP4',
                title: 'Video Resolution',
                subtitle: 'Legt die Breite der gerenderten Frames fest. Die Hoehe folgt dem Canvas-Seitenverhaeltnis.',
            ...
            videoProfile: {
                ...
                subtitle: 'Profil fuer den Video-Encoder.',
            },
            videoPreset: {
                type: 'select',
                label: 'Preset',
                prependIcon: 'mdi-speedometer',
                event: 'export:video-preset',
                active: exportData.value.type === 'MP4',
                options: [
                ...
                subtitle: 'Steuert das Verhaeltnis aus Qualitaet und Geschwindigkeit.',
            },
            videoEncoding: {
                type: 'select',
                label: 'Encoding',
                prependIcon: 'mdi-video-check',
                event: 'export:video-encoding',
                active: exportData.value.type === 'MP4',
                options: [
                    { title: 'Constant Quality (CRF)', value: 'crf' },
                    { title: 'Average Bitrate', value: 'average-bitrate' },
                ],
                title: 'Encoding Mode',
                subtitle: 'CRF nutzt eine konstante visuelle Qualitaet. Average Bitrate begrenzt die Zielbitrate.',
            },
            videoCrf: {
                type: 'number',
                label: 'CRF',
                ...
                max: 51,
                step: 1,
                event: 'export:video-crf',
                active: exportData.value.type === 'MP4' && exportData.value.videoEncoding === 'crf',
                title: 'Constant Quality',
                subtitle: 'Niedrigere Werte ergeben bessere Qualitaet. Standard ist 16.',
            ...
            videoBitrate: {
                ...
                max: 100000,
                step: 128,
                event: 'export:video-bitrate',
                active: exportData.value.type === 'MP4' && exportData.value.videoEncoding === 'average-bitrate',
                title: 'Average Bitrate',
                subtitle: 'Zielbitrate fuer den MP4-Export.',
                icon: 'mdi-chart-line',
            },
            useFileSystem: {
                type: 'checkbox',
                label: 'Use file system',
                event: 'export:use-filesystem',
                active: exportData.value.type === 'MP4',
                title: 'Frame Storage',
                subtitle: 'Speichert Frames waehrend des Exports auf dem Dateisystem statt sie nur temporaer zu halten.',
